class TicTacToe:
    ...
    def move(self,where,who):
        ...
        :return: a move,state pair, where the state is a copy of the current state with the additional move included
                 in this case, a move itself is a pair, where, and who moved there
                 and, yes, the where is also a pair
        """
